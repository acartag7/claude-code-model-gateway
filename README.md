...
| Provider | Models |
| --- | --- |
| Anthropic | Claude Fable 5, Claude Fable 5.1, Claude Opus 5, Claude Opus 4.8, Claude Sonnet 5 |
| OpenAI Codex | Daybreak Blue, GPT 6.0 Astra, GPT 5.3 Codex Spark, GPT 5.5, GPT 5.6 Luna, GPT 5.6 Sol, GPT 5.6 Terra |
